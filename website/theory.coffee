...
class FigureRect extends Figure
   constructor: (id,w,h) ->
      ...
      @screen =
         ...
         width : w*0.8
         vis : @R.path([
            "M", @screen.x - @screen.width/2, @screen.y,
            "h", @screen.width])
            .attr(opacity:"0.5")
...
class FigureCircle extends Figure
   constructor: (id,w,h) ->
      ...
      @screen =
         r : 50
         vis : @R.circle(@cam.x, @cam.y, @screen.r)
            .attr(fill:"none",opacity:"0.5")
