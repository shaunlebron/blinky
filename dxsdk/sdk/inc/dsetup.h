...
#define DSETUP_DIRECTX          (DSETUP_D3D | DSETUP_DDRAW | DSETUP_DSOUND | DSETUP_DPLAY | DSETUP_DDRAWDRV | DSETUP_DSOUNDDRV | DSETUP_DPLAYSP)
    ...
    int WINAPI DirectXDeviceDriverSetup(HWND hwnd, LPSTR driver_class,
					LPSTR inf_path, LPSTR driver_path,
					DWORD flags);
    ...
    typedef int (WINAPI * LPDIRECTXDEVICEDRIVERSETUP) (HWND, LPSTR, LPSTR,
						       LPSTR, DWORD);
